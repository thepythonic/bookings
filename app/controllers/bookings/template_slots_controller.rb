...
module Bookings
  class TemplateSlotsController < ApplicationController
    ...
    def create
      ...
      @template_slot.from_time = params[:from_time_hour].to_i * 60 + params[:from_time_minute].to_i
      @template_slot.to_time = params[:to_time_hour].to_i * 60 + params[:to_time_minute].to_i 
